...
/// [`AssetBundle::add_css_file`], [`AssetBundle::add_image_file`],
/// [`AssetBundle::add_font_file`], and (fulgur-smlr)
/// `blitz_adapter::resolve_style_imports`'s filesystem-based `@import`
/// resolution for inline `<style>` tags.
///
