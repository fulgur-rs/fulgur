...
pub(super) fn resolve_linear_gradient(
...
pub(super) fn resolve_color_stops(
...
pub(super) fn resolve_radial_gradient(
    g: &style::values::computed::Gradient,
    current_color: &style::color::AbsoluteColor,
) -> Option<(BgImageContent, f32, f32)> {
...
pub(super) fn resolve_conic_gradient(
    g: &style::values::computed::Gradient,
    current_color: &style::color::AbsoluteColor,
) -> Option<(BgImageContent, f32, f32)> {
...
pub(super) fn map_extent(e: style::values::generics::image::ShapeExtent) -> crate::pageable::RadialExtent {
...
pub(super) fn convert_bg_size(sizes: &[style::values::computed::BackgroundSize], i: usize) -> BgSize {
...
pub(super) fn convert_lp_to_bg(lp: &style::values::computed::LengthPercentage) -> BgLengthPercentage {
...
/// (CodeRabbit #238 で指摘)。
pub(super) fn try_convert_lp_to_bg(
...
pub(super) fn convert_bg_position(
...
pub(super) fn convert_bg_repeat(
...
pub(super) fn convert_bg_origin(
